...
_ICONS = {
    ...
    "procurement": '<path stroke-linecap="round" stroke-linejoin="round" d="M4 6h12l-1 8H5L4 6zm0 0L3.4 4H2M8 10h4"/><circle cx="7" cy="16.5" r="1"/><circle cx="13" cy="16.5" r="1"/>',
    "stethoscope": '<path stroke-linecap="round" stroke-linejoin="round" d="M5 3v5a4 4 0 008 0V3M9 12v2a4 4 0 004 4 4 4 0 004-4v-1"/><circle cx="17" cy="7" r="1.5"/>',
    "clipboard-check": '<path stroke-linecap="round" stroke-linejoin="round" d="M7 3h6v3H7V3zM5 5h10v12H5V5zm2 7l2 2 4-4"/>',
}
